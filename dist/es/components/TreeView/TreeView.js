...
export default class TreeView extends React.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "StyledAccordion", styled(Accordion)`
  ...
  `);
    ...
    _defineProperty(this, "createChildsConfig", (parentId, items, checked, indeterminate) => {
      ...
      if (hasChilds) {
        ...
        items.forEach(item => {
          ...
          childsConfig.config.push( /*#__PURE__*/React.createElement(List.Item, {
            key: item.id
    ...
    _defineProperty(this, "contentWrapper", el => el ? /*#__PURE__*/React.createElement("div", {
    ...
    _defineProperty(this, "addTitleTooltip", (title, id) => {
      ...
      if (title[0]) {
        clonedTitle[0] = /*#__PURE__*/React.createElement(TitleTooltipWrapper, {
          key: id,
          className: "titleTooltipWrapper"
        }, clonedTitle[0]);

        if (title[1]) {
          clonedTitle[1] = /*#__PURE__*/React.createElement("div", {
            key: "wrapper",
            className: "titleWrapper"
          }, title[0], " ", /*#__PURE__*/React.createElement("span", {
    ...
    _defineProperty(this, "getContent", obj => Array.isArray(_get(obj, "sections")) ? /*#__PURE__*/React.createElement(Accordion.Accordion, {
