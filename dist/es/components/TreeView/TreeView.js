...
export default class TreeView extends React.PureComponent {
  ...
  `);
    ...
    _defineProperty(this, "createChildsConfig", (parentId, items, checked, indeterminate) => {
      ...
      if (hasChilds) {
        ...
        items.forEach(item => {
          ...
          childsConfig.config.push(React.createElement(List.Item, {
            key: item.id
    ...
    _defineProperty(this, "contentWrapper", el => el ? React.createElement("div", {
    ...
    _defineProperty(this, "addTitleTooltip", (title, id) => {
      ...
      if (title[0]) {
        clonedTitle[0] = React.createElement(TitleTooltipWrapper, {
          key: id,
          className: "titleTooltipWrapper"
        }, clonedTitle[0]);

        if (title[1]) {
          clonedTitle[1] = React.createElement("div", {
            key: "wrapper",
    ...
    _defineProperty(this, "getContent", obj => Array.isArray(_get(obj, "sections")) ? React.createElement(Accordion.Accordion, {
