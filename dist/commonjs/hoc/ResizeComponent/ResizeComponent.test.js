...
describe("ResizeComponent HOC Component", () => {
  const MockComponent = () => _react.default.createElement("div", null, "Mock Component"); // eslint-disable-next-line new-cap


  const ResizeContainer = (0, _ResizeComponent.default)(MockComponent);
  let component;
  beforeEach(() => {
    component = (0, _enzyme.mount)(_react.default.createElement(ResizeContainer, null, "Testing Resize Component"));
  });
  afterEach(() => {
    component.unmount();
  });
