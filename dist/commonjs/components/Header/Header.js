...
const Header = ({
  ...
  }, _react.default.createElement("h2", null, title)), showRightElements && _react.default.createElement("div", {
    className: _HeaderModule.default.containeritemRight
  }, children));
}; // eslint-disable-next-line new-cap


var _default = _react.default.memo((0, _ResizeComponent.default)(Header));
