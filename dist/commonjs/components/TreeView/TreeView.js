...
class TreeView extends _react.default.PureComponent {
  ...
  `);
    ...
    _defineProperty(this, "createChildsConfig", (parentId, items, checked, indeterminate) => {
      ...
      if (hasChilds) {
        ...
        items.forEach(item => {
          ...
          childsConfig.config.push( /*#__PURE__*/_react.default.createElement(_semanticUiReact.List.Item, {
            key: item.id
    ...
    _defineProperty(this, "createTreeConfig", (parentId, items, checked, indeterminate) => {
      ...
      items.forEach(item => {
        ...
        if (item.childs) {
          ...
          itemConfig = {
            id: item.id,
            title: [/*#__PURE__*/_react.default.createElement(_semanticUiReact.Checkbox, {
              key: item.id,
              id: item.id,
              onClick: this.handleClickCheck,
              checked: isChecked,
    ...
    _defineProperty(this, "contentWrapper", el => el ? /*#__PURE__*/_react.default.createElement("div", {
    ...
    _defineProperty(this, "addTitleTooltip", (title, id) => {
      ...
      if (title[0]) {
        clonedTitle[0] = /*#__PURE__*/_react.default.createElement(TitleTooltipWrapper, {
          key: id,
          className: "titleTooltipWrapper"
        }, clonedTitle[0]);

        if (title[1]) {
          clonedTitle[1] = /*#__PURE__*/_react.default.createElement("div", {
            key: "wrapper",
            className: "titleWrapper"
          }, title[0], " ", /*#__PURE__*/_react.default.createElement("span", {
    ...
    _defineProperty(this, "getContent", obj => Array.isArray((0, _get2.default)(obj, "sections")) ? /*#__PURE__*/_react.default.createElement(_semanticUiReact.Accordion.Accordion, {
